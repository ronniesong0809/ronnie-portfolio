...
const About = ({ children, offset }) => (
  <>
    ...
    <Divider speed={0.1} offset={offset}>
      <UpDown>
        <SVG icon="hexa" hiddenMobile width={6} fill={colors.green} left="50%" top="75%" />
        ...
        <SVG icon="hexa" hiddenMobile width={24} fill={colors.green} left="80%" top="80%" />
      </UpDown>
      <UpDownWide>
        <SVG icon="hexa" hiddenMobile width={16} fill={colors.green} left="5%" top="80%" />
