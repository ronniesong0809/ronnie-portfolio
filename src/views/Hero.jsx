...
const Hero = ({ children, offset }) => (
  <>
    <Divider speed={0.2} offset={offset}>
      <UpDown>
        <SVG icon="hexa" hiddenMobile width={48} stroke={colors.green} left="10%" top="20%" />
        <SVG icon="hexa" width={48} stroke={colors.green} left="60%" top="70%" />
        <SVG icon="hexa" width={6} fill={colors['grey-darker']} left="60%" top="15%" />
      </UpDown>
      <UpDownWide>
        <SVG icon="hexa" hiddenMobile width={16} fill={colors.green} left="80%" top="10%" />
        <SVG icon="hexa" width={12} stroke={colors.green} left="90%" top="50%" />
        ...
        <SVG icon="hexa" width={16} stroke={colors.green} left="28%" top="15%" />
      ...
      <SVG icon="hexa" hiddenMobile width={64} fill={colors.green} left="5%" top="90%" />
